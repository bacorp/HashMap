...
//		int origin = Math.abs((multiplier * Math.abs(key.hashCode())) % modulus) % capacity;
		int pivot = this.hash(key);
		
//		if(origin != pivot){
//			// collision in this put
//			System.out.println(origin + ":" + pivot);
//			this.putCollision++;
//		}
